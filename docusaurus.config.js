...
const config = {
  ...
  tagline: 'Top 10 staTues tHat CriEd bloOd',
    ...
    [
      ...
      ({
        ...
        blog: {
          ...
          feedOptions: {
            title: 'Changelogs',
            description: 'Changelogs for various products',
            type: 'all',
  ...
  themeConfig:
    ...
    ({
      // announcementBar: {
      //   id: '2024_07-superiority-downtime',
      //   content:
      //     '<b>Superiority</b> is currently under maintenance. We\'re working on it and you can see live updates <b><a href="/changelogs/2024/07/31/superiority-downtime">right here</a></b>.',
      //   backgroundColor: '#ED4245',//'#1c1e21',
      //   textColor: '#000',
      //   isCloseable: true,
      // },
      ...
      footer: {
        ...
        logo: {
          alt: 'SupItsTom Logo',
          src: 'img/banner_wide_black.png',
          srcDark: 'img/banner_wide_white.png'
        },
        links: [
          {
            title: 'Documentation',
